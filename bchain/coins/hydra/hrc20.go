...
// FIXME
// func (b *HydraRPC) ethCall(data, to string) (string, error) {
...
func parseHrc20NumericProperty(contractDesc bchain.AddressDescriptor, data string) *big.Int {
	if has0xPrefix(data) {
		data = data[2:]
	}
	if len(data) > 64 {
...
func parseHrc20StringProperty(contractDesc bchain.AddressDescriptor, data string) string {
	...
	if len(data) > 128 {
		n := parseHrc20NumericProperty(contractDesc, data[64:128])
		if n != nil {
			l := n.Uint64()
...
// 		data, err := b.ethCall(hrc20NameSignature, address)
// 		if err != nil {
...
// 		if name != "" {
// 			data, err = b.ethCall(hrc20SymbolSignature, address)
// 			if err != nil {
...
// 			data, err = b.ethCall(hrc20DecimalsSignature, address)
// 			if err != nil {
...
// 				Symbol:   symbol,
// 			}
// 			d := parseHrc20NumericProperty(contractDesc, data)
// 			if d != nil {
...
// 		return nil, err
// 	}
// 	r := parseHrc20NumericProperty(contractDesc, data)
// 	if r == nil {
